  ...
  return [
    {
      ...
      content: [{
        ...
        text: [
          ...
          `The server may expose a factually safe draft for human review once revisions are exhausted (after ${QUALITY_MAX_REVISIONS} revision attempts) or once quality is judged to have stagnated across successive attempts, provided it scores at least ${QUALITY_REVIEW_SCORE}, every dimension is at least ${QUALITY_REVIEW_DIMENSION_FLOOR}, and the stricter review veto floors are met. This is labelled reviewable with notes, never PASS, and can never publish automatically.`,
