...
- Meta quality is carousel-first by contract: every candidate contains exactly two resolved concept routes with 3-6 ordered cards, exact source-asset mapping, crop intent and overlay guidance. The deterministic gate rejects packs that omit this structure.
